  ...
  return (
    <section className="py-15 bg-white">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        >
          EndevSystem <span className="text-(--color-brand)">Edge</span>
        </motion.h2>
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="bg-(--color-brand) text-white w-16 h-16 rounded-xl shadow-lg flex items-center justify-center"
                >
                  <Icon size={32} />
                </motion.div>
